...
- **Static Pre-rendering:** For production-grade performance, all subtopics should be pre-rendered into static HTML.
    ...
    - **Search Optimization:** The search index must be re-weighted during every build using `python3 generate_search_index.py`.
...
### 12.4 Home Page Index Compatibility (Completed)
