        ...
        <div class="sandbox-widget">
            ...
            <div class="controls-box">
                <div class="control-group">
                    <label for="slider-gravity">Gravity (<span style="color:#00d2ff;">$g$</span>): <span id="val-gravity">9.8</span> m/s²</label>
                    <input type="range" id="slider-gravity" min="0" max="25" step="0.1" value="9.8">
                </div>
                <div class="control-group">
                    <label for="slider-length">Length (<span style="color:#10b981;">$L$</span>): <span id="val-length">1.5</span> m</label>
                    <input type="range" id="slider-length" min="0.5" max="3.0" step="0.1" value="1.5">
                </div>
                <div class="control-group">
                    <label for="slider-damping">Damping (<span style="color:#ff4e88;">$\gamma$</span>): <span id="val-damping">0.10</span></label>
