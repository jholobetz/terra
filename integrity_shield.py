        ...
        if HAS_JSONSCHEMA:
            if self.schema:
                ...
                for file in files_to_validate:
                    ...
                    if file.endswith(".json") and file not in ["categories.json", "formulas.json", "constants.json", "entities.json", "search_index.json", "compiled_trie_regex.json", "notation.json", "particles.json", "pillar_profiles.json", "formula_aliases.json", "formulas_latex_index.json", "unindexed_subcomponents.json", "subcomponents_checkpoint.json"]:
