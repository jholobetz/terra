...
def restore():
    ...
    cm_data["formula_ids"] = ["bloch-theorem-8c31", "fermi-dirac-distribution-55ff", "heisenberg-hamiltonian-f5c7"]
    with open(cm_path, "w") as f:
        json.dump(cm_data, f, indent=4)
    print("  ✓ Condensed Matter restored.")

    # 2. Fluids & Nonlinear
    fn_path = os.path.join(TOPICS_DIR, "fluids-nonlinear.json")
    with open(fn_path, "r") as f:
        fn_data = json.load(f)
    fn_data["content"] = """<p>Fluid Dynamics is the comprehensive study of the macroscopic motion of continuous media, encompassing both liquids and gases. Coupled with the analysis of <a href="/physics/subtopic/nonlinear-dynamics" class="subtopic-link"><strong>Nonlinear Systems</strong></a>, it addresses complex phenomena ranging from laminar flow to turbulent chaos. This field utilizes a synthesis of vector calculus, conservation laws, and <a href="/physics/subtopic/chaos-theory" class="subtopic-link"><strong>Chaos Theory</strong></a> to explore the intricate, deeply nonlinear evolution of fluid parcels and dynamical states over time.</p>
    ...
    mm_data["formula_ids"] = ["cauchy-residue-theorem-8c31", "euler-lagrange-equation-55ff", "lie-algebra-commutation-f5c7"]
    with open(mm_path, "w") as f:
        json.dump(mm_data, f, indent=4)
    print("  ✓ Mathematical Methods restored.")
