...
def scan_disk_standards():
    ...
    for file in os.listdir(CONTENT_DIR):
        ...
        if file.endswith(".json") and file not in ["categories.json", "formulas.json", "constants.json", "search_index.json", "entities.json", "global_slug_registry.json", "compiled_trie_regex.json", "notation.json", "particles.json", "pillar_profiles.json", "formula_aliases.json", "formulas_latex_index.json"]:
