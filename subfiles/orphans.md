...
| :--- | :--- | :--- |
| Absence of Hydrogen | `absence-of-hydrogen` | 🟢 `platinum` |
| Density Parameters (\( \Omega \)) | `density-parameters` | 🟢 `platinum` |
...
| Silicon II | `silicon-ii` | 🟢 `platinum` |

## 📁 classical-mechanics.json

| Subtopic Title | Slug | Standard |
| :--- | :--- | :--- |
| Parallelism of L and Omega | `angular-momentum-parallelism` | 🟢 `platinum` |
| Coupled Oscillators | `coupled-oscillations` | 🟢 `platinum` |
| Damped Oscillations | `damped-oscillations` | 🟢 `platinum` |
| Driven Oscillations | `driven-oscillations` | 🟢 `platinum` |
...
| Wave Equation Derivation | `wave-equation-derivation` | 🟢 `platinum` |

## 📁 electromagnetism.json

| Subtopic Title | Slug | Standard |
| :--- | :--- | :--- |
| The Bohr Magneton (\(\mu_B\)) | `bohr-magneton` | 🟢 `platinum` |
| Bound Surface Current (\(\mathbf{K}_b\)) | `bound-surface-current` | 🟢 `platinum` |
| Bound Volume Current (\(\mathbf{J}_b\)) | `bound-volume-current` | 🟢 `platinum` |
| Contravariant 4-Vectors (\(V^\mu\)) | `contravariant-4-vector` | 🟢 `platinum` |
| Covariant Vectors (One-Forms) | `covariant` | 🟢 `platinum` |
| The Curl Operator (\(\nabla \times\)) | `curl-operator` | 🟢 `platinum` |
| Divergence (\( \nabla \cdot \)) | `divergence` | 🟢 `platinum` |
| The Geometric Bridge (Stokes' Theorem) | `geometric-bridge` | 🟢 `platinum` |
| The Gradient (\( \nabla \)) | `gradient` | 🟢 `platinum` |
| Lagrangian Formalism of the Lorentz Force | `lagrangian-lorentz-force` | 🟢 `platinum` |
| The Nabla Operator (\( \nabla \)) | `nabla-operator` | 🟢 `platinum` |
| Neutral Equilibrium and Invariant Potential | `neutral-equilibrium-physics` | 🟢 `platinum` |
| Permeability of Free Space (\(\mu_0\)) | `permeability-free-space` | 🟢 `platinum` |
| The Position 4-Vector (\(x^\mu\)) | `position-4-vector` | 🟢 `platinum` |
| Potential Definition and Reference Points | `potential-definition` | 🟢 `platinum` |
| The Propagation Vector (\(\mathbf{k}\)) | `propagation-vector` | 🟢 `platinum` |
| Source Summation (Superposition) | `source-summation` | 🟢 `platinum` |
| $U(1)$ Gauge Theory | `u1-gauge-theory` | 🟢 `platinum` |
| Voltage (Potential Difference) | `voltage` | 🟢 `platinum` |
| Wave Phase (\(\phi\)) | `wave-phase` | 🟢 `platinum` |
...
| Subtopic Title | Slug | Standard |
| :--- | :--- | :--- |
| The Constancy of Light Speed (\( c \)) | `constancy-of-light-speed` | 🟢 `platinum` |
| The Eötvös Parameter (\(\eta\)) | `eotvos-parameter` | 🟢 `platinum` |
| Fictitious Forces (Pseudo-Forces) | `fictitious-forces` | 🟢 `platinum` |
| The Principle of Galilean Relativity | `principle-galilean-relativity` | 🟢 `platinum` |

## 📁 standard-model.json

| Subtopic Title | Slug | Standard |
| :--- | :--- | :--- |
| The Asymmetry Parameter (\(\eta\)) | `asymmetry-parameter` | 🟢 `platinum` |
| Lepton Flavor Universality (LFU) | `lepton-flavor-universality` | 🟢 `platinum` |
| Parton Distribution Functions (PDFs) | `parton-distribution-functions` | 🟢 `platinum` |
| The Mechanism of Spontaneous Breaking | `spontaneous-breaking` | 🟢 `platinum` |
